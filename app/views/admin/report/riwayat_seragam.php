...
<head>
	...
	<link rel="stylesheet" href="../../../../public/assets/css/admin/report/riwayat_seragam1.css">
	...
	<title>Report Pembayaran Seragam</title>
</head>
			...
			<div class="Wrapper-table">
				...
				<table class="table">
					...
					<?php 
						...
						$query_mysqli = mysqli_query($conn,"SELECT * FROM seragam WHERE number_rek='$number_rek'")or die(mysqli_error());
						$nomor = 1;
