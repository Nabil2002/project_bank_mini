...
<head>
	...
	<link rel="stylesheet" href="../../../../public/assets/css/admin/report/riwayat_pembayaran.css">
	...
	<title>Report Pembayaran SPP</title>
</head>
			...
			<div class="Wrapper-table">
				...
				<table class="table">
					...
					<?php 
						...
						$query_mysqli = mysqli_query($conn,"SELECT * FROM tb_pembayaran WHERE number_rek='$number_rek'")or die(mysqli_error());
						$nomor = 1;
					...
					<tr>
						...
						<td class="column-content"><?php echo $data['nama']; ?></td>
						<td class="column-content"><?php echo $data['jenis_pembayaran']; ?></td>
						<td class="column-content"><?php echo $data['bulan']; ?></td>
						<td class="column-content"><?php echo $data['thn_ajaran']; ?></td>
